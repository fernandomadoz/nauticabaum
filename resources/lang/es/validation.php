...
return [
    ...
    */
    ...
    "alpha_dash"           => "El campo :attribute s&oacute;lo puede contener letras, n&uacute;meros y guiones (a-z, 0-9, -_).",
    ...
    "digits"               => "El campo :attribute debe ser un n&uacute;mero de :digits d&iacute;gitos.",
    ...
    "required_without_all" => "El campo :attribute es obligatorio cuando ning&uacute;n campo :values est&aacute;n presentes.",
    ...
    "string"               => "El formato del elemento :attribute deben ser caracteres.",
