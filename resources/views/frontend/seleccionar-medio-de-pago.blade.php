            ...
            <div class="row">
                ...
                <?php if (isset($mensaje)) { ?>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="<?php echo $class_mensaje ?>"><?php echo $mensaje ?></div>
                    </div>
                <?php } ?>
                                            ...
                                            <tr>
                                                <td colspan="4"> 
                                                    <div class="shop_btn_wrapper shop_car_btn_wrapper">
                                                        <ul>
                                                            <li>
                                                                <a onclick=" regComprarFB(); return gtag_report_conversion('<?php echo $preference->init_point; ?>')">Pagar con Mercado Pago</a>
                                                            </li>
                                                            <li><a onclick=" regComprarFB(); return gtag_report_conversion('<?php echo ENV('PATH_PUBLIC') ?>enviar-pedido');">Pagar con otros medios (*)</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <p>(*) <i><u>Pagar con otros medios:</u></i> Te dirigiremos a Whatsapp para que podamos asistirte con las diferentes formas de pago disponibles que tenemos para ofrecerte para pagar tu compra</p>
