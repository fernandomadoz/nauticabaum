...
<head>
  ...
  <title>Nautica Baum | Gestor de Contenidos</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-sun-o"></i> Nautica Baum</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu"> 
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Producto/8"><i class="fa fa-list"></i> Productos</a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Imagen_de_producto/2"><i class="fa fa-camera"></i> Imagenes de Producto</a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Imagen_de_galeria/2"><i class="fa fa-camera"></i> Imagenes de Galeria</a></li>   
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Slider/2"><i class="fa fa-newspaper-o"></i> Slider</a></li>  
